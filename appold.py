...
class PhotoTaskPlanner:
    ...
    def generate_task(self, params, history):
        ...
        exposures = self.generate_exposures(
            params["is_digital"], params.get("film_iso","400"), params["time_of_day"]
        )
        ...
        task = {
            ...
            "contingencies": "Adapt to weather, crowd, and light conditions",
            "success_criteria": ["✓ 1 decisive moment","✓ 1 reflection/minimalist abstract","✓ 10+ keeper shots"],
            "safety_note": "⚠️ Respect people/property; stay alert to surroundings"
        }
